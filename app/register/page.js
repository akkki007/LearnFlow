    ...
    <div className="flex min-h-screen items-center justify-start bg-white">
      <Card className="w-[50%] max-w-md mx-32 my-12 bg-white">
        <CardHeader className="space-y-1">
          <CardTitle className="text-center text-2xl font-bold text-emerald-800">Create an account</CardTitle>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-emerald-800">Full Name</FormLabel>
                    <FormControl>
                      <Input
              ...
              {role === "student" && (
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-emerald-800">Enrollment No</FormLabel>
                        <FormControl>
                          <Input
                            placeholder="123456"
                            className=" text-emerald-900"
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-emerald-800">Division</FormLabel>
                        <FormControl>
                          <Input
                            placeholder="A"
                            className=" text-emerald-900"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-emerald-800">Confirm Password</FormLabel>
                    <FormControl>
                      <div className="relative">
                        <Input
        ...
        <CardFooter className="flex justify-center border-t border-emerald-100 px-8 py-4">
          <p className="text-sm text-emerald-700">
            ...
            <Link href="/login" className="text-emerald-600 font-medium hover:text-emerald-800 hover:underline">
              Sign in
            </Link>
          </p>
        </CardFooter>
