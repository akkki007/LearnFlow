...
export default function About() {
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground poppins-regular">
          ...
          <div className="space-y-8">
            <div className="bg-white/5 p-6 rounded-xl backdrop-blur-sm border border-border/50">
              <p className="text-lg leading-relaxed text-primary poppins-regular">
                LearnFlow is an innovative learning platform designed to streamline 
                the educational experience for students and educators alike.
              </p>
            </div>
            
            <div className="mt-12">
              <h2 className="text-3xl font-bold mb-6 text-primary flex items-center gap-2 poppins-semibold">
                <span className="w-3 h-3 rounded-full bg-primary" />
                Our Mission
              </h2>
              <p className="text-lg leading-relaxed pl-5 border-l-2 border-primary/30 poppins-light">
            ...
            <div className="mt-12">
              ...
              <ul className="grid md:grid-cols-2 gap-4">
                <li className="flex items-start gap-3 p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
                  ...
                  <span className="poppins-medium">Attendance tracking</span>
                </li>
                <li className="flex items-start gap-3 p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
                  <span className="text-primary mt-1">•</span>
                  <span className="poppins-medium">Grade management</span>
                </li>
                <li className="flex items-start gap-3 p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
                  <span className="text-primary mt-1">•</span>
                  <span className="poppins-medium">Practical assignments</span>
                </li>
                <li className="flex items-start gap-3 p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
                  <span className="text-primary mt-1">•</span>
                  <span className="poppins-medium">Admin dashboard</span>
                </li>
              </ul>
            </div>
          </div>
